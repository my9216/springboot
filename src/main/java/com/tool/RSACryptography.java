...
public class RSACryptography {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //公钥加密
        byte[] encryptedBytes= Base64.getUrlEncoder().encode(encrypt(data.getBytes(), privateKey));
        System.out.println("加密后："+ encryptedBytes);
        //
        //        //私钥解密
        byte[] decryptedBytes=decrypt(Base64.getUrlDecoder().decode(encryptedBytes), publicKey);
